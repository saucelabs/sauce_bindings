...
public class SauceOptions extends com.saucelabs.saucebindings.options.SauceOptions {
   ...
   */
  @Deprecated public final List<String> w3cDefinedOptions = this.validOptions;

  /**
   * @deprecated Use sauce().validOptions instead
   */
  @Deprecated public final List<String> sauceDefinedOptions = sauce().validOptions;
   ...
   * @deprecated This method is no longer supported
   */
  @Deprecated public static final Map<String, String> knownCITools = SauceLabsOptions.knownCITools;
}

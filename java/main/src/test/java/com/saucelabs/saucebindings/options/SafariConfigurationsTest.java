...
public class SafariConfigurationsTest {
  ...
  public void buildsDefaultSauceOptions() {
    ...
    Assertions.assertEquals(Browser.SAFARI, sauceOptions.getBrowserName());
    Assertions.assertEquals(SaucePlatform.MAC_CATALINA, sauceOptions.getPlatformName());
  ...
  public void acceptsSafariOptionsClass() {
    ...
    Assertions.assertEquals(Browser.SAFARI, sauceOptions.getBrowserName());
    Assertions.assertEquals(safariOptions, sauceOptions.getCapabilities());
  }
  ...
  public void fluentOrderDoesNotMatter() {
    ...
    Assertions.assertEquals("12", sauceOptions.getBrowserVersion());

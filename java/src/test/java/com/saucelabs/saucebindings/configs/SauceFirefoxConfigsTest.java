...
public class SauceFirefoxConfigsTest {
    @Test
    public void createsSauceOptionsW3CValues() {
        SauceOptions options = SauceOptionsFactory.firefox()
        ...
        assertEquals(Browser.FIREFOX, options.getBrowserName());
    ...
    @Test
    public void createsSauceOptionsFirefoxValues() {
        ...
        assertEquals("0.20", sauceOptions.sauce().getGeckodriverVersion());
    ...
    @Test
    public void createsFirefoxOptionsFirefoxValues() {
        FirefoxOptions firefoxOptions = new FirefoxOptions();
        firefoxOptions.addArguments("--foo");

        SauceOptions sauceOptions = SauceOptionsFactory.firefox(firefoxOptions)
                .setPlatformName(SaucePlatform.MAC_CATALINA)

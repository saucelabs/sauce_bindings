...
public class SauceSafariConfigsTest {
    @Test
    public void createsSauceOptionsW3CValues() {
        SauceOptions options = SauceOptionsFactory.safari()
        ...
        assertEquals(Browser.SAFARI, options.getBrowserName());
    ...
    @Test
    public void createsSauceOptionsSafariValues() {
    ...
    @Test
    public void createsSafariOptionsSafariValues() {
        SafariOptions safariOptions = new SafariOptions();
        safariOptions.setAutomaticInspection(true);

        SauceOptions sauceOptions = SauceOptionsFactory.safari(safariOptions)
                .setPlatformName(SaucePlatform.MAC_CATALINA)
